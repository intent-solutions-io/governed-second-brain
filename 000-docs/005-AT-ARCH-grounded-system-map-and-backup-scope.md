...
_Snapshot 2026-07-14T10:43:45Z · auto-updated by [`bin/teamkb-systemmap.sh`](../bin/teamkb-systemmap.sh) (reads both SQLite DBs + du/find)._

| Store (`~/.teamkb/…`) | Size | Rows / files |
|---|---|---|
| `teamkb.db` — INTKB govern | 18M | candidates 2230 · curated_memories 2220 (active 1917 / superseded 303) · audit_events 2525 (v1 872 / v2 1653) · memory_links 302 |
...
| `kb-export/` — derived | 10M | — |
| `qmd-index/` — derived | 39M | — |
| **`~/.teamkb` total** | **214M** | — |

**curated_memories by category:** reference 1253 · pattern 571 · troubleshooting 297 · architecture 57 · decision 23 · convention 18 · onboarding 1.

**Backup:** latest `teamkb-full-20260714T104342Z.tar.zst.age` (2026-07-14T10:43:44Z) · daily timer `teamkb-backup.timer` (04:30).
<!-- /AUTOGEN:live-stats -->

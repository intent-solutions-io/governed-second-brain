...
_Snapshot 2026-07-10T10:39:46Z · auto-updated by [`bin/teamkb-systemmap.sh`](../bin/teamkb-systemmap.sh) (reads both SQLite DBs + du/find)._

| Store (`~/.teamkb/…`) | Size | Rows / files |
|---|---|---|
| `teamkb.db` — INTKB govern | 18M | candidates 2199 · curated_memories 2189 (active 1886 / superseded 303) · audit_events 2492 (v1 872 / v2 1620) · memory_links 302 |
| `brain/.ico/state.db` — ICO compile | 3.1M | — |
| `brain/raw/` — corpus (source of truth) | 13M | 726 files |
| `brain/wiki/` — compiled markdown | 13M | 2497 files |
| `brain/audit/` — ICO receipts | 6.8M | — |
| `brain/spool/` — ICO→INTKB handoff | 3.0M | — |
| `kb-export/` — derived | 9.9M | — |
| `qmd-index/` — derived | 39M | — |
| **`~/.teamkb` total** | **138M** | — |

**curated_memories by category:** reference 1251 · pattern 564 · troubleshooting 287 · architecture 54 · decision 17 · convention 15 · onboarding 1.

**Backup:** latest `teamkb-full-20260710T103942Z.tar.zst.age` (2026-07-10T10:39:46Z) · daily timer `teamkb-backup.timer` (04:30).
<!-- /AUTOGEN:live-stats -->

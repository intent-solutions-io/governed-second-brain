...
_Snapshot 2026-06-25T03:26:05Z · auto-updated by [`bin/teamkb-systemmap.sh`](../bin/teamkb-systemmap.sh) (reads both SQLite DBs + du/find)._

| Store (`~/.teamkb/…`) | Size | Rows / files |
|---|---|---|
| `teamkb.db` — INTKB govern | 17M | candidates 2064 · curated_memories 2054 (active 1752 / superseded 302) · audit_events 2356 (v1 872 / v2 1484) · memory_links 302 |
...
| `kb-export/` — derived | 3.8M | — |
| `qmd-index/` — derived | 8.9M | — |
| **`~/.teamkb` total** | **127M** | — |

**curated_memories by category:** reference 1245 · pattern 538 · troubleshooting 237 · architecture 34.

**Backup:** latest `teamkb-full-20260624T104142Z.tar.zst.age` (2026-06-24T10:41:46Z) · daily timer `teamkb-backup.timer` (04:30).
<!-- /AUTOGEN:live-stats -->

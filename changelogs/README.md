...
<!-- generated-at: 2026-07-18T17:49:38Z -->
...
| [`intentional-cognition-os`](intentional-cognition-os.md) | ICO — the COMPILE engine (deterministic kernel + Claude compiler) | `public` | [repo](https://github.com/jeremylongshore/intentional-cognition-os) | [v1.22.0] |
| [`qmd-team-intent-kb`](qmd-team-intent-kb.md) | INTKB — the GOVERN engine (control plane, audit chain) + brain HTTP API | `public` | [repo](https://github.com/jeremylongshore/qmd-team-intent-kb) | [0.8.0] |
...
### `intentional-cognition-os` — latest: [v1.22.0]
...
### `qmd-team-intent-kb` — latest: [0.8.0]
